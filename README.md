...
โครงการพัฒนา web-base dApp  ‘ฉกไข่ไดโนเสาร์’ มีวัตถุประสงค์ดังนี้
	...
	2 เพื่อฝึกกระบวนในการคิด วิเคราะห์ การออกแบบ และการเลือกใช้เครื่องมือในการ	ทำงานที่เหมาะสมกับโครงการ เช่น การใช้ Use Case Diagram รวมไปถึงการออกแบบ UI (User Interface Design) ให้มีความเรียบง่าย ลดความซับซ้อน 	สะดวกในการใช้งาน
	...
	5 เพื่อสร้างความน่าสนใจสนุกสนานแก่ผู้ที่สนใจเข้ามาศึกษาโครงการ โดยการนำไดโนเสาร์ ซึ่งเป็นตัวการ์ตูนที่ได้รับความนิยมในทุกๆวัยมาเป็นเครื่องมือในการสร้างความน่าสนใจ
